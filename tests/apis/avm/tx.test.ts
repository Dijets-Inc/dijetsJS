...
describe("Transactions", (): void => {
  ...
  beforeAll(async (): Promise<void> => {
    ...
    const result: Promise<Buffer> = api.getDJTXAssetID()
  ...
  beforeEach((): void => {
    ...
    amount = ONEDJTX.mul(new BN(amnt))
