...
import { CENTIDJTX } from "src/utils"
import { MILLIDJTX } from "src/utils"
...
describe("AVMAPI", (): void => {
  ...
  describe("Transactions", (): void => {
    ...
    beforeEach(async (): Promise<void> => {
      ...
      const result: Promise<Buffer> = avm.getDJTXAssetID(true)
      const payload: object = {
        result: {
          name,
          symbol,
