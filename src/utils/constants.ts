...
export const PrimaryAssetAlias: string = "DJTX"
export const MainnetAPI: string = "archiver.switzerlandnorth.cloudapp.azure.com"
export const FujiAPI: string = "api.djtx-test.network"
...
export const ONEDJTX: BN = new BN(1000000000)

export const DECIDJTX: BN = ONEDJTX.div(new BN(10))

export const CENTIDJTX: BN = ONEDJTX.div(new BN(100))

export const MILLIDJTX: BN = ONEDJTX.div(new BN(1000))

export const MICRODJTX: BN = ONEDJTX.div(new BN(1000000))

export const NANODJTX: BN = ONEDJTX.div(new BN(1000000000))

export const WEI: BN = new BN(1)

export const GWEI: BN = WEI.mul(new BN(1000000000))

export const DJTXGWEI: BN = NANODJTX.clone()

export const DJTXSTAKECAP: BN = ONEDJTX.mul(new BN(3000000))
...
const n0P: P = {
  ...
  fee: MILLIDJTX,
  creationTxFee: CENTIDJTX,
  createSubnetTx: ONEDJTX,
  createChainTx: ONEDJTX,
  minConsumption: 0.1,
  maxConsumption: 0.12,
  maxStakingDuration: new BN(31536000),
  maxSupply: new BN(720000000).mul(ONEDJTX),
  minStake: ONEDJTX.mul(new BN(2000)),
  minStakeDuration: 2 * 7 * 24 * 60 * 60, //two weeks
  maxStakeDuration: 365 * 24 * 60 * 60, // one year
  minDelegationStake: ONEDJTX.mul(new BN(25)),
...
// Start mainnet
let djtxAssetID: string = "7LKeAQgHrVG5kYJPuaJ14LJY36vqnpTQ6cLpUGA2W1kHk2Y9B"
const n1X: X = {
...
const n1P: P = {
  ...
  maxConsumption: 0.12,
  maxStakingDuration: new BN(31536000),
  maxSupply: new BN(100000000).mul(ONEDJTX),
  minStake: ONEDJTX.mul(new BN(2000)),
  minStakeDuration: 2 * 7 * 24 * 60 * 60, //two weeks
  maxStakeDuration: 365 * 24 * 60 * 60, // one year
  minDelegationStake: ONEDJTX.mul(new BN(25)),
