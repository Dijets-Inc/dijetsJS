...
describe("EVMAPI", () => {
    ...
    beforeAll(() => {
        api = new api_1.EVMAPI(avalanche, "/ext/bc/C/djtx", blockchainID);
    });
    afterEach(() => {
    ...
    test("refreshBlockchainID", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const testAPI = new api_1.EVMAPI(avalanche, "/ext/bc/C/djtx", n5bcID);
