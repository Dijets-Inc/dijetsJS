...
describe("CChain", () => {
    ...
    const tests_spec = [
        ...
        [
            "exportDJTX",
            () => cchain.exportDJTX(user, passwd, xChainAddr, new bn_js_1.default(10)),
            (x) => x,
